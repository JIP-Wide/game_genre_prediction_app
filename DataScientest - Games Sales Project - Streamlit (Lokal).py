...
if sections == "Project Overview":
    ...
    with layout_mario[0]:
        st.write("""
                ...
                This demo highlights the prediction of video game genres — a core component of our broader project on video game analysis. To accomplish this goal, 
                ...
                and enable targeted advertising strategies for different genres based on users’ preferences and experiences.
        ...
        with layout_features[0]:
            st.write("""
                    ...
                    **Game difficulty** emerged as the most influential feature, highlighting that difficulty levels play a critical role in genre classification. This 
                    ...
                    also stood out, indicating that completion rates — potentially influenced by gameplay length and style — are valuable for distinguishing genres.
...
if sections == "Project Conclusion":
    ...
    st.write("""
            ...
            predicting a user’s preferred genre accurately can boost user engagement and sales. Additionally, publishers could leverage this model to predict 
    ...
    with layout_credits_1[1]:
        st.markdown("""
                    ...
                    .image-link-container img {
                        height: 1em; /* Passt die Bildhöhe an die Schriftgröße an */
                        width: auto;
